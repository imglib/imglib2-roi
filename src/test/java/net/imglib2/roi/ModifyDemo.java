...
public class ModifyDemo
{
	...
	{
		// Create 3 WritableSpheres
		final WritableSphere s1 = new ClosedWritableSphere( new double[] { 0, 0, 0 }, 3.5 );
		final WritableSphere s2 = new ClosedWritableSphere( new double[] { 1, 2, 0 }, 1.5 );
		final WritableSphere s3 = new ClosedWritableSphere( new double[] { 2, 2, 0 }, 1.5 );

		// Combine the WritableSpheres using operators
